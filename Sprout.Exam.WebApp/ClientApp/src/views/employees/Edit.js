...
export class EmployeeEdit extends Component {
  ...
  handleSubmit(e) {
      ...
      if (this.state.fullName === '' || this.state.tin === '' || this.state.birthdate === '')
          alert("Please fillup all required field(s).");
      else
...
<div className='form-group col-md-6'>
  ...
  <input type='text' className='form-control' id='inputFullName4' onChange={this.handleChange.bind(this)} name="fullName" value={this.state.fullName} placeholder='Full Name' maxLength='50' />
</div>
<div className='form-group col-md-6'>
...
<div className='form-group col-md-6'>
  ...
  <input type='text' className='form-control' id='inputTin4' onChange={this.handleChange.bind(this)} value={this.state.tin} name="tin" placeholder='TIN' maxLength='20' />
</div>
<div className='form-group col-md-6'>
...
<button type="button" onClick={() => this.props.history.push("/employees/index")} className="btn btn-primary">Back</button>
  ...
  async getEmployee(id) {
    ...
    debugger;
    this.setState({ id: data.id, fullName: data.fullName, birthdate: moment(data.birthdate).format('YYYY-MM-DD'), tin: data.tin, typeId: data.employeeTypeId, loading: false, loadingSave: false });
  }
}
