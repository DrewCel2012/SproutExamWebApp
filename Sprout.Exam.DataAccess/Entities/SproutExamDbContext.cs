...
namespace Sprout.Exam.DataAccess.Entities
{
    public partial class SproutExamDbContext : DbContext
    {
        ...
        public SproutExamDbContext()
        {
            ...
            //_configuration = ConfigurationHelper.GetConfigurationSection("ConnectionStrings");
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Server=DREWCEL\\SQLEXPRESS; Database=SproutExamDb; User ID=sa; Password=P@$$.1234");
                //optionsBuilder.UseSqlServer(_configuration.GetValue<string>("DefaultConnection"));
